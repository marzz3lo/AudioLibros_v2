...
/**
 * Created by marzzelo on 19/1/2017.
 */
...
public class ZoomSeekBar extends View {
    ...
    private OnChangeValueListener escuchador;
...
// Dibujamos Escala
    ...
    public void setOnChangeValueListener(OnChangeValueListener escuchador) {
    ...
    public void setEscalaMin(int escalaMin) {
        if (escalaMin <= valMax && escalaMin >= valMin) {
    ...
    public void setEscalaMax(int escalaMax) {
        if (escalaMax <= valMax && escalaMax >= valMin) {
